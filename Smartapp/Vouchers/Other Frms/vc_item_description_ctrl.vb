...
Public Class vc_item_description_ctrl
    ...
    Private Sub vc_item_description_ctrl_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Txt1.Text = Inventory_Vouchers_frm.Sp_controls1.Find_description_lab(obj).Text
    ...
    Public Function load()
        ...
        Item_GST_Type = Inventory_Vouchers_frm.Sp_controls1.find_taxtype_lab(obj).Text
        SUB_Total = Val(Inventory_Vouchers_frm.Sp_controls1.Find_amt_TXT(obj).Text)
        Head_Acc_ID = Val(Inventory_Vouchers_frm.Sp_controls1.Find_HeadAcc_ID(obj).Text)
        ...
        If GST_YN = True And Item_GST_Type = "Taxable" Then
            ...
            With Inventory_Vouchers_frm.Sp_controls1
                ...
                If TAX_Type = "CS" Then
                    ...
                    CGST_ID = .Find_CGST_ID(obj).Text
                    SGST_ID = .Find_SGST_ID(obj).Text
    ...
    Public Function Fill_Source()
        ...
        GST_Per = nUmBeR_FORMATE(Val(Find_DT_Value(Database_File.cre, "TBL_Stock_Item", "TAX_Value", $"ID = '{Inventory_Vouchers_frm.Sp_controls1.Find_AccID_Label(obj).Text}'")))
        Cess_Per = nUmBeR_FORMATE(Val(Find_DT_Value(Database_File.cre, "TBL_Stock_Item", "Cess_Value", $"ID = '{Inventory_Vouchers_frm.Sp_controls1.Find_AccID_Label(obj).Text}'")))
        Tax_Type_Item = ((Find_DT_Value(Database_File.cre, "TBL_Stock_Item", "Tax_Type", $"ID = '{Inventory_Vouchers_frm.Sp_controls1.Find_AccID_Label(obj).Text}'")))
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
                ...
                If CGST_TXT.Text = "" Then
                    If Msg_Custom_YN(NOT_Location.Bottom_Right, Color.Red, My.Resources.Warning_animation_icn, Dialoag_Button.Yes_No, "Error", "CGST Not Found", "Ledger account of CGST is not created,<nl>so you cannot add CGST.<nl><nl>Do you want to create a CGST account?") = DialogResult.Yes Then
                        ...
                        With Ledger_frm
                            ...
                            .close_focus_obj = Inventory_Vouchers_frm.Sp_controls1.Find_amt_TXT(obj)
                            .close_link_yn = False
        ...
        With Inventory_Vouchers_frm.Sp_controls1
            .Find_description_lab(obj).Text = Txt1.Text
            .find_tax_per_lab(obj).Text = Val(Label26.Text) + Val(Label25.Text) + Val(Label24.Text)
            .Find_gstamt_TXT(obj).Text = nUmBeR_FORMATE(Label19.Text)
            .Find_HeadAcc_ID(obj).Text = Head_Acc_ID
            .find_cess_per(obj).Text = Label33.Text
            .Find_cess_amt(obj).Text = Label35.Text

            .Find_CGST_ID(obj).Text = CGST_ID
            .Find_SGST_ID(obj).Text = SGST_ID
            .Find_IGST_ID(obj).Text = IGST_ID
            .Find_Cess_ID(obj).Text = Cess_ID

            .Vc_GST_summary_ctrl1.Refresh_Data_()
