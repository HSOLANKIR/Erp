...
Public Class Payroll_Employee_Summary
    ...
    Private Sub Payroll_Employee_Summary_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        BG_frm.HADE_TXT.Text = "Payroll Employee Summary"
    ...
    Private Sub Payroll_Employee_Summary_Enter(sender As Object, e As EventArgs) Handles Me.Enter
    ...
    Private Sub Payroll_Employee_Summary_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Escape Then
            Me.Dispose()
        End If
    End Sub

    Private Sub Payroll_Employee_Summary_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
...
where " & Date_Filter & Where_Filter() & " and VC.Voucher_Type = 'Payroll' and vc.CR_DR = 'Under' and em.Under = '" & VC_ID_ & "'

GROUP BY Particuls
ORDER BY sum(Dr),sum(Cr)", cn)
    ...
    Private Sub Payroll_Employee_Summary_GotFocus(sender As Object, e As EventArgs) Handles Me.GotFocus
        BG_frm.From_ID = From_ID
    End Sub
End Class